...
with Standard errors estimated using
$$\hat SE(\hat \mu_{W}) = \sqrt{(1-\frac{n}{N})\frac{Var(S_1)}{n}}$$ where $Var(S_1)$ is the variance of turns in $S_1$
$$\hat SE(\hat \mu_{W}) = \sqrt{\sum_{h=1}^{5}(\frac{N_h}{N})^2(1-\frac{n_h}{N_h})\frac{Var(S_{1,h})}{n_h}}$$ where $Var(S_{1,h})$ is the variance of turns in strata h in $St_1$.
